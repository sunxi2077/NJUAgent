 ...
 * turn against a temporary workspace, then prints only model ID, status,
 * latency and pass/fail. It never prints request headers, response text or
 * environment values.
 */
...
async function main(): Promise<void> {
  ...
  console.log(
    `SMOKE model=${model} text_turn=${textResult.status} ` +
